...
.. glossary::
    ...
    EERS 
        Église évangélique réformée de Suisse (a remplacé: :term:`FEPS`)

    FEPS 
        Fédérations des Églises protestantes de Suisse (remplacé par :term:`EERS`)
    ...
    CER
        ...
        Conférence des Églises réformées de Suisse romande

    OPEC
        Office protestant d'éditions chrétiennes (organisation de la :term:`CER`)

    OPF
        Office protestant de la formation (organisation de la :term:`CER`)
